...
interface Earth extends THREE.Object3D {
...
export class TimeUtils {
    ...
    public update(timestamp: number): void {
        ...
        document.dispatchEvent(new CustomEvent<TimeState>('timeUpdate', {
            detail: { 
    ...
    public setTimeWarp(value: number): void {
    ...
    public setSimulatedTime(newTime: string | Date): void {
    ...
    public calculateEarthVelocity(): THREE.Vector3 {
    ...
    public getEarthTilt(): THREE.Vector3 {
    ...
    public getGreenwichSiderealTime(): number {
    ...
    public getFractionOfDay(): number {
        const now = this.simulatedTime;
    ...
    public getGreenwichPosition(earth: Earth): THREE.Vector3 {
        ...
        position.applyQuaternion(new THREE.Quaternion().setFromAxisAngle(
            new THREE.Vector3(0, 1, 0),
            Math.PI * 1.5
        ));
