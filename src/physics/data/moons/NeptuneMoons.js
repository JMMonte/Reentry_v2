...
export default [
    {
        ...
        mass: tritonMass, // kg
        radius: 1353.4, // km
        GM: PhysicsConstants.PHYSICS.G * tritonMass, // km³/s² (1.42e12 / 1e9)
        density: 2061, // kg/m³
    ...
    },
    {
        ...
        mass: proteusMass, // kg
        radius: 210, // km
        GM: PhysicsConstants.PHYSICS.G * proteusMass, // km³/s² (2.1e8 / 1e9)
        density: 1300, // kg/m³
    ...
    },
    {
        ...
        mass: nereidMass, // kg
        radius: 170, // km
        GM: PhysicsConstants.PHYSICS.G * nereidMass, // km³/s² (2.9e8 / 1e9)
