...
export default [
    {
        ...
        mass: arielMass, // kg
        radius: 578.9, // km
        GM: PhysicsConstants.PHYSICS.G * arielMass, // km³/s²
        density: 1353, // kg/m³
    ...
    },
    {
        ...
        mass: umbrielMass, // kg
        radius: 584.7, // km
        GM: PhysicsConstants.PHYSICS.G * umbrielMass, // km³/s²
        density: 1399, // kg/m³
    ...
    },
    {
        ...
        mass: titaniaMass, // kg
        radius: 788.9, // km
        GM: PhysicsConstants.PHYSICS.G * titaniaMass, // km³/s²
        density: 1711, // kg/m³
    ...
    },
    {
        ...
        mass: oberonMass, // kg
        radius: 761.4, // km
        GM: PhysicsConstants.PHYSICS.G * oberonMass, // km³/s²
        density: 1563, // kg/m³
    ...
    },
    {
        ...
        mass: mirandaMass, // kg
        radius: 235.8, // km
        GM: PhysicsConstants.PHYSICS.G * mirandaMass, // km³/s²
