...
export default [
    {
        ...
        mass: ioMass, // kg
        radius: 1_821.6, // km
        GM: PhysicsConstants.PHYSICS.G * ioMass, // km³/s²
...

    {
        ...
        mass: europaMass, // kg
        radius: 1_560.8, // km
        GM: PhysicsConstants.PHYSICS.G * europaMass, // km³/s²
...

    {
        ...
        GM: PhysicsConstants.PHYSICS.G * ganymedeMass, // km³/s²
...

    {
        ...
        radius: 2_410.3, // km
        GM: PhysicsConstants.PHYSICS.G * callistoMass, // km³/s²
    ...
    // Non-Galilean moons
    {
        ...
        GM: PhysicsConstants.PHYSICS.G * amaltheaMass, // km³/s² (calculated from mass)
    ...
    },
    {
        ...
        GM: PhysicsConstants.PHYSICS.G * himaliaMass, // km³/s² (calculated from mass)
    ...
    },
    {
        ...
        GM: PhysicsConstants.PHYSICS.G * thebeMass, // km³/s² (calculated from mass)
    ...
    },
    {
        ...
        GM: PhysicsConstants.PHYSICS.G * elaraMass, // km³/s² (calculated from mass)
        isDwarf: true, // Small irregular moon
...

    {
        ...
        GM: PhysicsConstants.PHYSICS.G * pasiphaeMass, // km³/s² (calculated from mass)
        isDwarf: true, // Small irregular moon
...

    {
        ...
        GM: PhysicsConstants.PHYSICS.G * sinopeMass, // km³/s² (calculated from mass)
        isDwarf: true, // Small irregular moon
...

    {
        ...
        GM: PhysicsConstants.PHYSICS.G * lysitheaMass, // km³/s² (calculated from mass)
        isDwarf: true, // Small irregular moon
...

    {
        ...
        GM: PhysicsConstants.PHYSICS.G * carmeMass, // km³/s² (calculated from mass)
        isDwarf: true, // Small irregular moon
...

    {
        ...
        GM: PhysicsConstants.PHYSICS.G * anankeMass, // km³/s² (calculated from mass)
        isDwarf: true, // Small irregular moon
...

    {
        ...
        GM: PhysicsConstants.PHYSICS.G * ledaMass, // km³/s² (calculated from mass)
        isDwarf: true, // Small irregular moon
