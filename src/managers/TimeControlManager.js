export class TimeControlManager {
    constructor(timeUtils) {
        ...
        this.timeWarpOptions = [0, 1, 3, 10, 30, 100, 300, 1000, 3000, 10000, 30000, 100000];
        this.currentTimeWarpIndex = 1; // Start at 1x
    ...
    initializeListeners() {
        ...
        document.addEventListener('timeUpdate', (event) => {
            ...
            this.updateFormattedTime(simulatedTime);
        });

        // Initialize with the default time warp value
        this.timeUtils.setTimeWarp(this.timeWarpOptions[this.currentTimeWarpIndex]);
    }

    updateFormattedTime(simulatedTime) {
