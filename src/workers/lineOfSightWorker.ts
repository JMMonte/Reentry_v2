...
interface UpdateSatellitesMessage {
    type: 'UPDATE_SATELLITES';
    satellites: Satellite[];
}

interface UpdateBodiesMessage {
    type: 'UPDATE_BODIES';
}
...
type WorkerIncomingMessage = UpdateSatellitesMessage | UpdateBodiesMessage;
type WorkerOutgoingMessage = ConnectionsUpdatedMessage;
...
self.onmessage = function(e: MessageEvent<WorkerIncomingMessage>): void {
...
function calculateLineOfSight(): void {
