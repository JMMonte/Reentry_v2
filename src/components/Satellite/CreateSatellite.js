...
import { SatelliteDebugWindow } from '../ui/satellite/SatelliteDebugWindow.js';
    ...
    if (app.physicsWorker && app.workerInitialized) {
        app.physicsWorker.postMessage({
            ...
            data: {
                ...
                velocity: {
                    x: newSatellite.velocity.x / Constants.metersToKm,
                    y: newSatellite.velocity.y / Constants.metersToKm,
                    z: newSatellite.velocity.z / Constants.metersToKm
                },
